...
export const DemoToggle = () => {
  ...
  return (
    <button
      ...
      style={{
        borderColor: isDemoMode ? "hsl(var(--foreground) / 0.3)" : "hsl(var(--primary))",
        background: isDemoMode ? "hsl(var(--foreground) / 0.05)" : "hsl(var(--primary) / 0.1)",
        color: isDemoMode ? "hsl(var(--foreground))" : "hsl(var(--primary))",
      }}
